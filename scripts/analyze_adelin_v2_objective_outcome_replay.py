        ...
        json.dumps(
            {
                ...
                "candidate_volatility_bucket_distribution": summary["candidate_volatility_bucket_distribution"],
                "control_volatility_bucket_distribution": summary["control_volatility_bucket_distribution"],
                ...
                "source_metrics_with_confidence": summary["source_metrics_with_confidence"],
                "pre_registered_criteria_loaded": summary["pre_registered_criteria_loaded"],
                "pre_registered_criteria_source_path": summary["pre_registered_criteria_source_path"],
                "pre_registered_verdict": summary["pre_registered_verdict"],
                "verdict_reason": summary["verdict_reason"],
                "decision_source": summary["decision_source"],
                "decision_metric": summary["decision_metric"],
                "decision_effect_size": summary["decision_effect_size"],
                "decision_effect_size_ci95_lower": summary["decision_effect_size_ci95_lower"],
                "decision_effect_size_ci95_upper": summary["decision_effect_size_ci95_upper"],
                "decision_effect_size_excludes_zero": summary["decision_effect_size_excludes_zero"],
                "decision_robustness_note": summary["decision_robustness_note"],
                "recommended_next_action": summary["recommended_next_action"],
                "eligible_sources": summary["eligible_sources"],
                "ineligible_sources": summary["ineligible_sources"],
