...
def _lex_to_dict(lex: LiquidityExpansionSignal | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "rr_tp1": lex.rr_tp1,
        "rr_tp4": lex.rr_tp4,
        "reference_type": lex.reference_type,
        "reference_price": lex.reference_price,
        "sl_risk": lex.sl_risk,
        "sl_conservative": lex.sl_conservative,
        "rr_to_tp1_risk": lex.rr_to_tp1_risk,
        "rr_to_tp4_risk": lex.rr_to_tp4_risk,
        "rr_to_tp1_conservative": lex.rr_to_tp1_conservative,
        "rr_to_tp4_conservative": lex.rr_to_tp4_conservative,
