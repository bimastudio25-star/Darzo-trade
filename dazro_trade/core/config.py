...
class Settings:
    ...
    approaching_alert_distance_pips: float = 15.0
    armed_alert_distance_pips: float = 8.0
    imminent_reaction_distance_pips: float = 5.0
    allow_far_prep_alerts: bool = False
    far_prep_alert_distance_pips: float = 25.0
    ...
    reaction_cluster_tolerance_pips: float = 10.0
    ...
    def from_env(cls, env_file: str | os.PathLike[str] | None = ".env") -> "Settings":
        ...
        return cls(
            ...
            min_reaction_distance_pips=_float("MIN_REACTION_DISTANCE_PIPS", 8.0),
            approaching_alert_distance_pips=_float("APPROACHING_ALERT_DISTANCE_PIPS", 15.0),
            armed_alert_distance_pips=_float("ARMED_ALERT_DISTANCE_PIPS", 8.0),
            imminent_reaction_distance_pips=_float("IMMINENT_REACTION_DISTANCE_PIPS", 5.0),
            allow_far_prep_alerts=_bool(os.getenv("ALLOW_FAR_PREP_ALERTS"), False),
            far_prep_alert_distance_pips=_float("FAR_PREP_ALERT_DISTANCE_PIPS", 25.0),
            ...
            min_normal_reaction_target_pips=_float("MIN_NORMAL_REACTION_TARGET_PIPS", 5.0),
            preferred_reaction_target_pips=_float("PREFERRED_REACTION_TARGET_PIPS", 10.0),
            allow_vwap_1r_target=_bool(os.getenv("ALLOW_VWAP_1R_TARGET"), True),
            min_vwap_target_pips=_float("MIN_VWAP_TARGET_PIPS", 3.0),
            ...
            min_gap_between_official_targets_pips=_float("MIN_GAP_BETWEEN_OFFICIAL_TARGETS_PIPS", 5.0),
            min_gap_between_scalp_targets_pips=_float("MIN_GAP_BETWEEN_SCALP_TARGETS_PIPS", 3.0),
            target_cluster_tolerance_pips=_float("TARGET_CLUSTER_TOLERANCE_PIPS", 2.5),
            min_tp1_distance_pips=_float("MIN_TP1_DISTANCE_PIPS", 5.0),
            min_tp1_distance_pips_vwap_scalp=_float("MIN_TP1_DISTANCE_PIPS_VWAP_SCALP", 3.0),
            ...
            theoretical_sl_buffer_pips=_float("THEORETICAL_SL_BUFFER_PIPS", 1.0),
            min_stop_distance_pips=_float("MIN_STOP_DISTANCE_PIPS", 2.0),
            max_stop_distance_pips=_float("MAX_STOP_DISTANCE_PIPS", 15.0),
            reaction_cluster_tolerance_pips=_float("REACTION_CLUSTER_TOLERANCE_PIPS", 10.0),
